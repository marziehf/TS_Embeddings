...
void hdp_state::setup_state_from_corpus(const corpus * c)
{
    ...
    printf(" end of setup_state_from_corpus \n");
}
...
double hdp_state::table_partition_likelihood()
{
    ...
    printf("table partition likelihood: %d \n", likelihood);
    return likelihood;
}
...
double hdp_state::data_likelihood()
{
    ...
    //printf("%d num of topics \n", m_num_topics);  
    printf("data: %d, %d \n", sizeof(m_word_counts_by_zw), sizeof(m_word_counts_by_zw[0]));
    for (int k = 0; k < m_num_topics; k++)
    {
...
//     printf("Likelihood: %d \n", likelihood);
   ...
   //     printf("Likelihood2: %d \n", likelihood);
    }
    printf("data likelihood: %d \n", likelihood);
    return likelihood;
}
